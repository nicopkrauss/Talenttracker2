  ...
  return (
    <div className="max-w-md space-y-4">
      ...
      <div>
        ...
        <input
          type="email"
          className="w-full px-3 py-2 border border-red-300 dark:border-red-700 rounded-md bg-background text-foreground placeholder:text-muted-foreground focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20"
