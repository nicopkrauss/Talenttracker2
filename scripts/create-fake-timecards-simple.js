// Simple script to create fake timecards using SQL
const { execSync } = require('child_process')

// SQL to create fake timecards
const createTimecardsSql = `
...
console.log('🎲 Creating fake timecards...')
console.log('📝 This will create realistic timecard data for testing the approval interface')

try {
  // Write SQL to a temporary file
  require('fs').writeFileSync('temp_timecards.sql', createTimecardsSql)
  
  console.log('💾 SQL script created, you can run it manually in your database')
  console.log('📄 File: temp_timecards.sql')
  console.log('')
  console.log('🔧 To run this script:')
  console.log('1. Copy the contents of temp_timecards.sql')
  console.log('2. Run it in your Supabase SQL editor')
  console.log('3. Check the results in the timecards table')
  console.log('')
  console.log('📊 This will create approximately 25 timecards with:')
  console.log('   - Various statuses (draft, submitted, approved, rejected)')
  console.log('   - Some with manual edit flags')
  console.log('   - Realistic work hours and break times')
  console.log('   - Different pay rates based on roles')
  console.log('   - Appropriate comments and timestamps')
